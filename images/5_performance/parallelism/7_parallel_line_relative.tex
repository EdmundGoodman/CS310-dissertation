...
legend style={fill opacity=0.8, draw opacity=1, text opacity=1, anchor=south east, at={(0.97,0.03)},}, % draw=none},
tick align=outside,
tick pos=left,
...
\addlegendentry{Baseline C++ with OpenMP threading}
...
\addplot [semithick, crimson2143940, mark=triangle, mark size=3, mark options={solid}]
table {%
...
\addlegendentry{Relative Rust with 1 Rayon thread}
\addplot [semithick, mediumpurple148103189, mark=star, mark size=3, mark options={solid}]
table {%
...
\addlegendentry{Relative Rust with 8 Rayon threads}
\addplot [semithick, sienna1408675, mark=diamond, mark size=3, mark options={solid}]
table {%
...
\addlegendentry{Relative Rust with 32 Rayon threads}
\end{axis}
