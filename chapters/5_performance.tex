...
\begin{figure}[H]
    \centering
    \include{images/5_performance/parallelism/25_translation_parallelism_rust.tex}
...
\begin{figure}[H]
    \centering
    \include{images/5_performance/parallelism/24_translation_parallelism_cpp.tex}
...
% TODO: Check updates from conclusion re-write
