...
% Describe the approaches you have used to evaluate that the solution you have designed in \Cref{ch:translation} and executed in \Cref{ch:hpc-multibench} actually solves the problem identified in \Cref{ch:introduction}.
